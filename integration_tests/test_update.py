...
class UpdateTests(unittest.TestCase):
    def setUp(self):
        ...
        self.manifest.write_text(self.manifest.read_text().replace("0.5.7", "0.3.4"))
    ...
    def test_update_validates_real_loader_and_selftest_preserving_profile(self):
        ...
        self.assertEqual(yaml.safe_load(self.manifest.read_text())["version"], "0.5.7")
    ...
    def test_current_035_pilot_can_upgrade(self):
        ...
        self.assertEqual(update(self.bundle, self.home)["version"], "0.5.7")
