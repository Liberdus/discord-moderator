...
class UpdateTests(unittest.TestCase):
    def setUp(self):
        ...
        self.manifest.write_text(self.manifest.read_text().replace("0.5.9", "0.3.4"))
    ...
    def test_update_validates_real_loader_and_selftest_preserving_profile(self):
        ...
        self.assertEqual(yaml.safe_load(self.manifest.read_text())["version"], "0.5.9")
    ...
    def test_missing_new_runtime_module_refuses_update_without_replacing_plugin(self):
        ...
        for module in ('health', 'summary', 'manual_delete', 'connection_health'):
