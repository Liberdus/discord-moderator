...
class UpdateTests(unittest.TestCase):
    def setUp(self):
        ...
        self.manifest.write_text(self.manifest.read_text().replace("0.3.4", "0.3.3"))
    ...
    def test_original_030_pilot_can_also_upgrade(self):
        self.manifest.write_text(self.manifest.read_text().replace("0.3.3", "0.3.0"))
        self.assertEqual(update(self.bundle, self.home)["version"], "0.3.4")
