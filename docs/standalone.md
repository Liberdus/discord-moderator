...
sudo .venv/bin/liberdus-moderator install-service \
  --wheel dist/liberdus_discord_moderator-0.7.1-py3-none-any.whl --start
```
...
### Update an existing 0.6.x or 0.7.0 system service to 0.7.1
