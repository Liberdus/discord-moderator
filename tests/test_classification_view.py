...
class SavedClassificationTests(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_expiration_is_historical_without_pruning_or_writes(self):
        ...
        self.assertIn("**Historical result:** evidence window expired", text)
