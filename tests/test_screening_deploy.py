...
from scripts import apply_screening_update as helper
...
class DeploymentTests(unittest.TestCase):
    def invoke(self, *, failure=None, wrong_hash=False, user='hermes'):
        ...
        with tempfile.TemporaryDirectory() as temp:
            ...
            def run(argv):
                ...
                if argv[-1]=='screen': return '{"configured":"screen","platform_enabled":false}'
                if argv[-1].endswith('update.pyz'): return '{"updated":true,"version":"0.4.0"}'
                return ''
    ...
    def test_success_updates_then_configures_before_enabling(self):
        ...
        self.assertEqual(calls[3][-1],'screen')
