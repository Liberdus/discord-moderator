...
class LiveSession:
    ...
    def command(self, event, message_id, connected):
        ...
        if not response["ok"]:
            ...
            return "Moderation command: " + response["error"] + ". Use !mod status, pause, resume, incident ID, explain ID, or selftest."
        ...
        if event.command in ("incident", "explain"):
            ...
            # Only trusted metadata and validated typed fields enter the layout.
            return format_incident(response["data"])
