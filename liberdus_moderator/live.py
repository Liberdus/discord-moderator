    ...
    def command(self, event, message_id, connected):
        ...
        if event.command == "help":
            ...
            return panel("Moderation help", [
                ...
                "Authorized staff in bot-mod.", "Enforcement remains disabled."])
        ...
        if event.command in ("status", "pause", "resume"):
            ...
            return panel("Liberdus moderation", lines + ["", "Enforcement: disabled", "Commands: !mod help"])
        ...
        if event.command == "review":
            ...
            return (f"**Moderator review saved**\nLabel: {label}\n"
                    ...
                    "Legacy content label only; staff review unchanged. JEV retained; enforcement disabled.\n"
