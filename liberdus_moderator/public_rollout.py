...
def apply_plan(profile, get, *, now=None, enable_deletion=False):
    ...
    if manifest.get('name') != 'liberdus-moderator' or manifest.get('version') != '0.6.1':
        raise RolloutError('Install the reviewed 0.6.1 plugin while disabled before applying scope.')
