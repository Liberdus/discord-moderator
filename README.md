...
1. The [JEV baseline](docs/jev-batch.md#baseline-results--september-20-2026) is complete with one mixed-purpose disagreement. Review label precedence before a deliberate rubric change or targeted comparison; keep the original 9/10 baseline and existing shadow limits. No repeat installation or baseline run is needed.
