...
**Standalone 0.8.0:** native `/mod` commands replace the old Hermes menu. Authorized
...
Version 0.8.0 adds [bounded message catch-up](docs/catch-up.md) after disconnects
and unexpected restarts. Recovered flags are labeled for staff review and never
automatically deleted. `/mod status` shows progress; incomplete coverage produces
a private staff notice.
