...
1. The [0.3.3 formatted incident lookup](docs/incident-review.md) is confirmed live. Next, review varied, labeled rule-triggering examples in the existing test scope, recording intended labels and disagreements. Keep JEV in shadow mode and retain the existing limits.
