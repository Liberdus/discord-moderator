...
1. Apply the [0.3.3 layout update](docs/incident-review.md) and inspect the same saved incident in `bot-mod` on the portrait phone screen. No new provider call is needed. Then review varied, labeled rule-triggering examples in the existing test scope.
